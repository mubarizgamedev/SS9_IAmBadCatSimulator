...
public class SciFiBeamScript : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            beamStart = Instantiate(beamStartPrefab[currentBeam], LaserPoint.position, Quaternion.identity) as GameObject;
            beamEnd = Instantiate(beamEndPrefab[currentBeam], LaserPoint.position, Quaternion.identity) as GameObject;
            beam = Instantiate(beamLineRendererPrefab[currentBeam], LaserPoint.position, Quaternion.identity) as GameObject;
